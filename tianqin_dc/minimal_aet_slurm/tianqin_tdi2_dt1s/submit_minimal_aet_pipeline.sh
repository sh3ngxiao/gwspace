...
MERGE_DEPENDENCY="afterok:${DWD_JOB}:${SMBHB_JOB}:${SBBH_JOB}:${EMRI_JOB}"
MERGE_JOB="$(sbatch --parsable --dependency="$MERGE_DEPENDENCY" "$SCRIPT_DIR/run_minimal_all_sources_merged_aet.slurm.sh")"
